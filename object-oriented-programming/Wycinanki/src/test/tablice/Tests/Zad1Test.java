...
public class Zad1Test {
    ...
    void testWłasnościSkalarów() {
        Skalar skalar = new SkalarDane(1.0);
    ...
    void testWłasnościWektorów() {
        Wektor wektor1 = new WektorDane(new double[]{1.0, 2.0, 1.0}, true);
        Wektor wektor2 = new WektorDane(new double[]{2.0, 2.0, 3.0}, false);
    ...
    void testWłasnościMacierzy() {
        Macierz matrix = new MacierzDane(new double[][]{
                {1.0, 0.0, 2.0},
                {2.0, 1.0, 3.0},
                {1.0, 1.0, 1.0},
                {2.0, 3.0, 1.0}
    ...
    void testArytmetykiSkalarów() throws ZłyIndeks {
        ...
        Skalar skalar2 = new SkalarDane(11.5);
        assertEquals(new SkalarDane(15.0), skalar1.suma(skalar2));

        Skalar skalar3 = new SkalarDane(3.0);
        Skalar skalar4 = new SkalarDane(12.0);
        assertEquals(new SkalarDane(36.0), skalar3.iloczyn(skalar4));
    }
    ...
    void testArytmetykiWektorSkalar() throws ZłyIndeks {
        for(boolean b: new boolean[]{true, false}) {
            ...
            Skalar skalar = new SkalarDane(3.0);
            Wektor wektor1 = new WektorDane(new double[]{1.0, 2.5}, b);
            assertEquals(new WektorDane(new double[]{4.0, 5.5}, b),
                           wektor1.suma(skalar));

            // [1.5, 2.25] * 4.0 = [6.0, 9.0]
            Wektor wektor2 = new WektorDane(new double[]{1.5, 2.25}, b);
            assertEquals(new WektorDane(new double[]{6.0, 9.0}, b),
                         wektor2.iloczyn(new SkalarDane(4.0)));
        }  // for b
    }
    ...
    void testArytmetykiSkalarMacierz() throws ZłyIndeks{
        ...
        Macierz oczekiwanyWynikMnożenia = new MacierzDane(new double[][]{
                {-3.75, -9.0, 36.0},
                {153.0, -24.0, -10.5}
        });
    ...
    void testDodawaniaIMnożeniaWektorWektor() throws ZłyIndeks, NiezgodnośćRozmiarów {
        ...
        Wektor wektor2 = new WektorDane(new double[]{1.0, 1.0, -2.0}, true);
        assertEquals(new WektorDane(new double[]{2.0, 3.0, 1.0}, true),
                wektor1.suma(wektor2));

        Wektor wektor3 = new WektorDane(new double[]{-2.0, 5.0}, false);
        Wektor wektor4 = new WektorDane(new double[]{-5.0, 2.0}, false);
        assertEquals(new WektorDane(new double[]{-7.0, 7.0}, false),
                wektor3.suma(wektor4));

        // Wektor * Wektor (Scalar result)
        Wektor wektor5 = new WektorDane(new double[]{3.0, 2.0, -1.0}, true);
        Wektor wektor6 = new WektorDane(new double[]{-2.0, 2.0, 1.0}, true);
        assertEquals(new SkalarDane(-3.0), wektor5.iloczyn(wektor6));

        Wektor wektor7 = new WektorDane(new double[]{-2.0, -5.0, 1.0, 3.0}, false);
        Wektor wektor8 = new WektorDane(new double[]{-5.0, 1.0, 2.0, -3.0}, false);
        assertEquals(new SkalarDane(-2.0), wektor7.iloczyn(wektor8));

        Wektor wektor9 = new WektorDane(new double[]{1.0, 1.0, -2.0}, false);
        assertEquals(new MacierzDane(new double[][]{{-3.0}}), wektor1.iloczyn(wektor9));

        Wektor wektor10 = new WektorDane(new double[]{1.0, 2.0, 3.0}, false);
        Wektor wektor11 = new WektorDane(new double[]{1.0, 1.0, -2.0}, true);
    ...
    void testDodawaniaWektorMacierz() throws ZłyIndeks, NiezgodnośćRozmiarów {
        // Wektor + Macierz
        Wektor wektor1 = new WektorDane(new double[]{3.0, 1.5, -2.0}, true);
        ...
        Wektor wektor2 = new WektorDane(new double[]{7.5, -5.0}, false);
        assertEquals(new MacierzDane(new double[][]{
                {8.5, 11.0, -4.5},
                {-10.0, 3.0, -2.0}
    ...
    void testMnożeniaWektorMacierz() throws ZłyIndeks, NiezgodnośćRozmiarów {
        // Wektor * Macierz
        Wektor wektor1 = new WektorDane(new double[]{1.0, 2.0, 3.0}, true);
        Wektor wektor2 = new WektorDane(new double[]{1.0, 1.0, -2.0}, false);
        assertEquals(new MacierzDane(new double[][]{{-3.0}}), wektor1.iloczyn(wektor2));

        Wektor wektor3 = new WektorDane(new double[]{1.0, 2.0, 3.0}, false);
        Wektor wektor4 = new WektorDane(new double[]{1.0, 1.0, -2.0}, true);
        Macierz macierz1 = new MacierzDane(new double[][]{
                {1.0, 1.0, -2.0},
                {2.0, 2.0, -4.0},
                {3.0, 3.0, -6.0}
    ...
    void testMnożeniaMacierzWektor() throws ZłyIndeks, NiezgodnośćRozmiarów {
        ...
        Wektor wektor1 = new WektorDane(new double[]{-1.0, 3.0}, false);
        Wektor oczekiwany1 = new WektorDane(new double[]{5.0, -9.0, 1.0}, false);
        ...
        Wektor oczekiwany2 = new WektorDane(new double[]{2.0, 6.0}, true);
    ...
    void testNegacji() {
        ...
        assertEquals(new SkalarDane(-17.0), skalar.negacja());
    ...
    void testPrzypisaniaWektorów() throws NiezgodnośćRozmiarów {
        ...
        Wektor wektor1 = new WektorDane(new double[]{1.5, 2.5, 3.5}, false);
        Wektor wektor2 = new WektorDane(new double[]{-1.0, 0.0, 1.0}, false);
        wektor2.przypisz(wektor1);
        assertEquals(new WektorDane(new double[]{1.5, 2.5, 3.5}, false), wektor2);

        // Przypisz wektor [1.5, 2.5, 3.5] do wektora [-1.0, 0.0, 1.0] (wektor wierszowy i kolumnowy)
        Wektor wektor3 = new WektorDane(new double[]{-1.0, 0.0, 1.0}, true);
        wektor3.przypisz(wektor1);
        assertEquals(new WektorDane(new double[]{1.5, 2.5, 3.5}, false), wektor3);
    ...
    void testWycinków() throws BłędneZakresy, NiezgodnośćRozmiarów {
        Skalar skalar = new SkalarDane(13.125);
        assertEquals(skalar, skalar.wycinek());

        Wektor wektor = new WektorDane(new double[]{1.0, 21.0, 32.0, 43.0, 54.0}, true);
        Wektor oczekiwanyWycinekWektora = new WektorDane(new double[]{32.0, 43.0}, true);
        ...
        Macierz oczekiwanyWycinekMacierzy = new MacierzDane(new double[][]{
                {15.0, -31.0},
                {-31.0, 25.0},
                {25.0, 7.0}
        });
